...
assert.ok(css.includes("--net-warn:rgb(201 88 24)"), "warning samples must use the deeper orange tone")
assert.ok(css.includes("--net-bad:rgb(188 52 49)"), "bad samples must use the clearer soft red tone")
