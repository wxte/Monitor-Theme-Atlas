...
assert.ok(source.includes("hours=168&points=60&series=ping"), "overview cards must request the documented 7-day ping window")
assert.ok(source.includes("function refreshOverviewWeek"), "overview 7-day cache refresh missing")
