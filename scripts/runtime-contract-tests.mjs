...
assert.ok(css.includes("--meter-neutral:#5f646b"), "shared darker light meter gray missing")
...
assert.ok(css.includes("--net-warn:rgb(218 143 72)"), "warning samples must use the orange tone")
assert.ok(css.includes("--net-bad:rgb(207 98 92)"), "bad samples must use the warmer soft red tone")
