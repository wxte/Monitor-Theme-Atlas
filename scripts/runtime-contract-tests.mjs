...
assert.ok(css.includes("--loss-ok:rgb(82 158 112)"), "packet-loss tender green missing")
...
assert.ok(css.includes("--traffic-ok:rgb(82 158 112)"), "traffic bar must start with the same tender green")
