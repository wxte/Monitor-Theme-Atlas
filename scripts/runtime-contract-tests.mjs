...
assert.ok(css.includes("--meter-neutral:#4e5359"), "shared deeper light meter gray missing")
...
assert.ok(css.includes("--net-warn:rgb(214 124 54)"), "warning samples must use the deeper orange tone")
assert.ok(css.includes("--net-bad:rgb(204 82 78)"), "bad samples must use the clearer soft red tone")
