...
assert.ok(css.includes("--meter-neutral:#3f444a"), "shared deeper light meter gray missing")
...
assert.ok(css.includes("--net-warn:rgb(216 111 42)"), "warning samples must use the deeper orange tone")
assert.ok(css.includes("--net-bad:rgb(205 70 66)"), "bad samples must use the clearer soft red tone")
